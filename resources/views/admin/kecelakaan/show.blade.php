    ...
    <div class="ps-3">
        <nav>
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active">Detail kecelakaan Kecelakaan</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-5 text-center">
                ...
                <img class="img-fluid rounded shadow w-100"
                     src="{{ route('admin.admin.kecelakaanKerja.image', $kecelakaan->id) }}"
                     alt="{{ $kecelakaan->nama }}"
            ...
            <div class="col-md-7">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($kecelakaan->tanggal)->format('d F Y') }}</td>
                    </tr>

                    <tr>
                        <th>Deskripsi Kejadian</th>
                        <td style="white-space: pre-line;">
                            {{ $kecelakaan->deskripsi }}
                        </td>
                    </tr>
                </table>
